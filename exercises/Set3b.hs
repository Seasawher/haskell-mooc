...
indexDefault (a : as) 0 def = a
indexDefault (a : as) i def = indexDefault as (i - 1) def
...
sumsOf :: [Int] -> [Int]
sumsOf [] = []
sumsOf (a : as) = a : mymap (a+) (sumsOf as)
