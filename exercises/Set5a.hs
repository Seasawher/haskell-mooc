...
totalPrice (MkShoppingEntry name price count) = (fromIntegral count) * price
...
setName name (MkPerson old_name age) = MkPerson name age

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (MkPerson name old_age) = MkPerson name age
...
data Position = MkPosition { x_axis :: Int, y_axis :: Int }
